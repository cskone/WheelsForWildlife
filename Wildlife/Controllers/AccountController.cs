...
namespace Wildlife.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    if (role == "Inactive")
                    {
                        ModelState.AddModelError("", "Inactive Account. Contact Admins if you believe this to be a mistake.");
                        return View(model);
                    }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { FirstName = model.FirstName, LastName = model.LastName, UserName = model.Email, Email = model.Email, DriverLocation = new CivicAddress() };
